...
export default function Result() {
    ...
    <div className="displayResult">
      <div className="gridImagesResult">
        ...
        <p className="resultP">
          ...
          though. Basically you carefully filter what is worth preserving and
          then take care of those chosen things carefully. The result is that
          you surround yourself with beautiful things that deserve your
          attention.
        </p>{" "}
      </div>
    </div>
  ...
  const Norman = () => (
    <div className="displayResult">
      <div className="gridImagesResult">
        {" "}
        <h2 className="h1Question">Norman - you like horror stories </h2>{" "}
        ...
        <p className="resultP">
          You love to tickle your mind with true crime stories and horror
          movies, but that does not mean that you are a bad seed yourself. You
          are just fascinated by the dark and intimidating sides of life and
          humans. You love to indulge in the psychology of the mind and often
          practice what you have learned there in the real life.
        </p>{" "}
      </div>
    </div>
  );
    ...
    <div className="displayResult">
      <div className="gridImagesResult">
        ...
        <p className="resultP">
          ...
          but feel a strong connection to your ancestral line and spirituality
          at the same time. You would love to see more meaningful architecture
          in your daily life and it makes you a little sad that more and more of
          that is replaced by soulless buildings. You don’t want to lose touch
  ...
  const Pyramid = () => (
    <div className="displayResult">
      <div className="gridImagesResult">
        {" "}
        <h2 className="h1Question">Pyramid - the mystic</h2>{" "}
        ...
        <p className="resultP">
          You are a pyramid. You are mysterious, but magnetic. Many people look
          up to you. Not all of them understand you and your impact and yet they
          are mesmerized by your presence. But this effect didn’t come to you
          easily. It took many years of work for you to get there, to build up
          that image and foundation. You got a lot of help and now is the time
          to give back. You may be or end up as a philanthropist that is
          involved in many projects that help others.
        </p>{" "}
      </div>
    </div>
  );
    ...
    <div className="displayResult">
      <div className="gridImagesResult">
        ...
        <p className="resultP">
          ...
          cherry on the top. You probably speak French or plan to learn it in
          the future. You are high class, but you are not kitschy. So you ditch
          the extra layer of gold to brag with and cut down to what is actually
          important. You are likely invested into trading. Many look up to you
          and not a few of them envy you. Through your elegant aura you manage
          to gain a lot of power and followers and your actions have impact.
          Being a mentor may be your role.
        </p>{" "}
      </div>
    </div>
  );
    ...
    <div className="displayResult">
      <div className="gridImagesResult">
        ...
        <p className="resultP">
          ...
          quickly, but your role is to preserve the old, sacred knowledge.
          People love and respect you as you are and you have the rare privilege
          to not have to change yourself to fit in.
        </p>{" "}
      </div>
    </div>
  );
    ...
    <div className="displayResult">
      <div className="gridImagesResult">
        ...
        <p className="resultP">
          ...
          play hard. You enjoy your free time with family and friends and love
          to invite your neighbors for a barbecue. You are well adjusted to our
  ...
  const OldNew = () => (
    <div className="displayResult">
      <div className="gridImagesResult">
        {" "}
        <h2 className="h1Question">
          Mixing old with new - The story teller
        </h2>{" "}
        ...
        <p className="resultP">
          ...
          style, people may be irritated as they perceive you as an extrovert
    ...
    <div className="displayResult">
      <div className="gridImagesResult">
        ...
        <p className="resultP">
          ...
          neighborhood too much. You don’t need to see the world. Your
          environment is what you love and you chose that on purpose. You love
          your daily routine and you work with what you have. The goals you set
          aren’t set too high and you rarely exhaust yourself. It is very rare
          that you are stressed out. People love that about you. They feel very
          safe and comforting being around you.
        </p>{" "}
      </div>
    </div>
  );
  ...
  const Bhutanese = () => (
    <div className="displayResult">
      <div className="gridImagesResult">
        ...
        <p className="resultP">
          You are irritated by how fast things go out there in the big cities
          and decide that it’s not for you anymore. Instead you have spent time
          ...
          wisdom that others can perceive. Whenever they need advice they turn
          to you.
        </p>{" "}
      </div>
    </div>
  ...
  const FirstTier = () => (
    <div className="displayResult">
      <div className="gridImagesResult">
        {" "}
        <h2 className="h1Question">
          Chinese First Tier City Architecture- The hustler
        </h2>{" "}
        ...
        <p className="resultP">
          ...
          hustling and winning. You love modern life and feel very comfortable
          on the fast lane. It is possible that you are a manager or
          entrepreneur. You don’t mind looking back to the past, but mainly
          because you use the knowledge for your current projects. It is
          possible that you may change the world one day with your impact and
          energy to strive forwards.
        </p>{" "}
      </div>
    </div>
  );
  ...
  const Bauhaus = () => (
    <div className="displayResult">
      <div className="gridImagesResult">
        {" "}
        <h2 className="h1Question">Bauhaus - Modern pragmatic</h2>{" "}
        ...
        <p className="resultP">
          ...
          not cluttered with many useless things, but rather things you use
          daily and that look stylish at the same time. You are a good and
          respectful listener and give great advice as you focus on the
          important things in life. Decluttering the world and helping others as
          their muse is a role that fits you well.
        </p>{" "}
      </div>
    </div>
  );
  ...
  const ArtNouveau = () => (
    <div className="displayResult">
      <div className="gridImagesResult">
        {" "}
        <h2 className="h1Question">Art Nouveau - The art lover</h2>{" "}
        ...
        <p className="resultP">
          ...
          and sweet ideas. To come up with those you do need a lot of
          inspiration yourself as well and you don’t mind picking it up through
          weekly gallery and museum visits.
        </p>{" "}
      </div>
    </div>
  );
  ...
  const Mosque = () => (
    <div className="displayResult">
      <div className="gridImagesResult">
        {" "}
        <h2 className="h1Question">Mosque - The spiritual</h2>{" "}
        ...
        <p className="resultP">
          ...
          Listening to and helping others is a big part of your life. Life can
          be tough, but you feel support through your spirituality and that
          gives you energy, even with rocky parts of the road ahead. Keep going
          your way. For many you are the oasis of trust and hope they are
          yearning to find.
        </p>{" "}
      </div>
    </div>
  ...
  const Industrial = () => (
    <div className="displayResult">
      <div className="gridImagesResult">
        {" "}
        <h2 className="h1Question">
          Industrial Architecture - You are part of a subculture
        </h2>{" "}
        ...
        <p className="resultP">
          On the outside you don’t really seem that exciting, but when one gets
          to know you, it suddenly becomes clear that there is so much to you.
          You don’t like to spend much time on decorating the fassade and
          putting on fancy outfits, in fact you see that rather as a waste of
          time and look down on giving the appearance too much attention. What
          counts for you is on the inside and you hold much exclusive knowledge
          there. Therefore it is not surprising that you rather connect with a
          specific subculture than the mainstream.
        </p>{" "}
      </div>
    </div>
  );
  ...
  const Brutalist = () => (
    <div className="displayResult">
      <div className="gridImagesResult">
        {" "}
        <h2 className="h1Question">Brutalist - The curious one</h2>{" "}
        ...
        <p className="resultP">
          ...
          You strive for power and top positions to make sure you are secured.
          Is it possible though that sometimes you are provocative and that way
          start arguments with others? Your motives are not always very clear to
          others. Something you definitely deserve credit for though is that you
          are very curious. When you feel safe, you like to leave your comfort
          zone and explore new perspectives.
        </p>{" "}
      </div>
    </div>
  );
  ...
  const Contemporary = () => (
    <div className="displayResult">
      <div className="gridImagesResult">
        {" "}
        <h2 className="h1Question">Contemporary - Living in the moment</h2>{" "}
  ...
  const Glass = () => (
    <div className="displayResult">
      <div className="gridImagesResult">
        {" "}
        <h2 className="h1Question">Glass buildung - The sensitive one</h2>{" "}
        ...
        <p className="resultP">
          ...
          Nevertheless you like this trait of yours and wouldn’t stop being you
          no matter what. That makes you a great source of support and
          inspiration for others, even if it is hard sometimes. Your
          contribution to society is immense though and you are appreciated by
          many.
        </p>{" "}
      </div>
    </div>
  ...
  const Result = () => (
    <div className="">
      ...
      <div className="">
        {traditional === 1 && mainstream > specific ? <Contemporary /> : null}
        {traditional === 1 && mainstream < specific ? <Glass /> : null}
